...
% Emiliya : P.95, Section 3.2: typo (alternations --> alterations)
...
% Emiliya : Example 3.4.3: Production technology could be explained better.
...
% Emiliya : Cournot-Nash exchange mechanism: How is this different from a general equilibrium analysis?
...
% Emiliya : The use of the term ``peasant'' may need some justification
